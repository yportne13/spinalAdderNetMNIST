...
class ANN(
  ...
  val l1 = new Layer(1,16,2,0,28,28,8,13,1,SubNum = 10*256, DivNum = 2, ChoutDivHard = 4)
  l1.io.input.valid := Delay(flip,1,init = False)//io.valid_in
  l1.io.input.payload  := l1in//io.data_in

  val l2 = new Layer(16,32,2,1,12,12,13,17,2,SubNum = 130*256, DivNum = 3, ChoutDivHard = 2)
  l2.io.input := l1.io.output

  val l3 = new Layer(32,16,2,1,6,6,17,Q,3,SubNum = 280*256, DivNum = 4, ChoutDivHard = 2)
  l3.io.input := l2.io.output

  val l4 = new Layer(16,10,1,0,3,3,Q,Q,4,SubNum = 0, DivNum = 0, noReLu = true)
